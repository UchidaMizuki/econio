...
iotable_dummy <- list(
  regional_noncompetitive_import = read_iotable_dummy_regional(path(
    dir,
    "regional-noncompetitive_import",
    ext = "csv"
  )),
  regional_competitive_import = read_iotable_dummy_regional(path(
    dir,
    "regional-competitive_import",
    ext = "csv"
  )),
  multiregional_noncompetitive_import = read_iotable_dummy_multiregional(path(
    dir,
    "multiregional-noncompetitive_import",
    ext = "csv"
  )),
  multiregional_competitive_import = read_iotable_dummy_multiregional(path(
    dir,
    "multiregional-competitive_import",
    ext = "csv"
  ))
)
